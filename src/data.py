...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose([
            # YOUR CODE HERE
            # Randomly resize and crop the image to size 224x224
            transforms.RandomResizedCrop(224),
            # Data augmentation techniques for training
            transforms.RandomHorizontalFlip(p=0.3), # Random horizontal flip with a probability of 0.3
            ...
            transforms.RandomChoice([
                ...
                ]), # Randomly apply color jittering with different parameters
